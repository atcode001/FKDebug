...
(function () {
    function sslHook() {
        ...
        fKLog.kLog("init DroidSSLUnpinning.js init hook success")
        /*
        hook list:
        1.SSLcontext
        2.okhttp
        ...
        */
        ...
        Java.use("java.security.KeyStore$PrivateKeyEntry").getPrivateKey.implementation = function () {
            ...
            var path = '/sdcard/Download/' + packageName + uuid(10, 16) + '.p12';
            storeP12(this.getPrivateKey(), this.getCertificate(), path, 'r0ysue'); 

            fKLog.kCLog({
                name: "dumpClinetCertificate",
                type:"getPrivateKey",
                path: path, 
                pwd: "r0ysue"
            });
    ...
    */
        ...
        /*
        XposedHelpers.findAndHookMethod("okhttp3.OkHttpClient.Builder", lpparam.classLoader, "certificatePinner", "okhttp3.CertificatePinner", new XC_MethodReplacement() {
            @Override
    ...
    */
        ...
        try {
            ...
            var okhttp3_OkHttpClient_Builder = Java.use('okhttp3.OkHttpClient$Builder');
            okhttp3_OkHttpClient_Builder.certificatePinner.overload('okhttp3.CertificatePinner').implementation = function (pinner) {
                return this;
            }
            ...
            quiet_send('OkHTTP 3.x Found1');


        } catch (err) {
            fKLog.kCLog({ name: "okhttp3", err: err });
        ...
        try {
            var okhttp3_RealCall = Java.use('okhttp3.internal.connection.RealCall');
            okhttp3_RealCall.execute.overload().implementation = function () {
    ...
    ***/
        ...
        try {
            ...
            TrustManagerImpl.verifyChain.implementation = function (untrustedChain, trustAnchorChain, host, clientAuth, ocspData, tlsSctData) {
                fKLog.kALog("TrustManagerImpl verifyChain called " + host);
        ...
        var base = Process.findModuleByName("libflutter.so");
        if (base != null) {
            function hook_ssl_verify_result(address) {
                ...
                Interceptor.attach(address, {
                    ...
                    onEnter: function (args) {
                        fKLog.kLog("libflutter Disabling SSL validation")
                    },
                    onLeave: function (retval) {
                        fKLog.kLog("libflutter Retval: " + retval)
                        retval.replace(0x1);
                    }
                });
            }

            function disablePinning(flutter) {
                fKLog.kLog({ name: "droidssl", flutter: flutter })
                //.text: 00000000003E1058 49 E8 FF F0 29 71 0B 91       ADRL            X9, aSslClient; "ssl_client"
                //.text: 00000000003E1060 8A E8 FF F0 4A 09 03 91       ADRL            X10, aSslServer; "ssl_server"
                //函数头
                //5FDF60
                var pattern = "FF C3 01 D1 FD 7B 01 A9 FC 6F 02 A9 FA 67 03 A9 F8 5F 04 A9 F6 57 05 A9 F4 4F 06 A9 08 0A 80 52 48 00 00 39 1A 54 40 F9"//3E0F74 // A8 02 00 B4
                var res = Memory.scan(flutter.base, flutter.size, pattern, {
                    onMatch: function (address, size) {
                        //var nextBase = address.add(40);
                        //if (nextBase.add(1).readU8() == 0x02 & nextBase.add(1).readU8() == 00 && nextBase.add(1).readU8() == 0xB4) {
                        //    fKLog.kLog('libflutter [+] ssl_verify_result found at: ' + address.toString());
                        //    // Add 0x01 because it's a THUMB function
                        //    hook_ssl_verify_result(address);
                        //}
                    },
                    onError: function (reason) {
                        fKLog.kLog('libflutter [!] There was an error scanning memory');
                    },
                    onComplete: function () {
                        fKLog.kLog("libflutter All done")
                    }
                });
            }
            disablePinning(base);
        } else {
            fKLog.kLog("not found libflutter")
        }
    }
