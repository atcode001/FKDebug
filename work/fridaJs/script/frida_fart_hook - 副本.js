...
function GetSavepath() {
    var dir = savepath + get_self_process_name();
    chmod(dir);
    return dir;
}
function hookart() {
    ...
    if (addrLoadMethod == null) {
        ...
        for (var i = 0; i < symbols.length; i++) {
            ...
            if (symbol.name.indexOf("ClassLinker") >= 0
                ...
                console.log("Java.androidVersion(" + Java.androidVersion + ") addrLoadMethod " + symbol.name);
                break;
            }
        }
    }
                ...
                if (this.dexfileptr != null) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            console.log("filepath:", dexfile_path, e);
                        }
                    }
                }
...
function dumpcodeitem(artmethodobj) {
    if (artmethodobj != null) {
        ...
        if (dex_code_item_offset_ != null && dex_code_item_offset_ > 0) {
            var file_path = savepath + "/" + dexfilesize + "_" + Process.getCurrentThreadId() + ".bin";
...
function dumpall() {
    console.log("start dump all CodeItem......." + artmethod_maps.length);
