...
(function () {
    ...
    function nativeHookFunction(addr, function_name) {
        Interceptor.attach(addr, {
            onEnter: function (args) {
                this.logs = {};
                this.logs.call = function_name;
                this.logs.traceback = Thread.backtrace(this.context, Backtracer.ACCURATE).map(DebugSymbol.fromAddress).join('\n') + '\n';
                this.arg0 = args[0];
                this.arg1 = args[1];
                this.arg2 = args[2];
                this.arg3 = args[3];
                ...
                this.logs.arg0 = hexdumpMem(this.arg0);
                this.logs.arg1 = hexdumpMem(this.arg1);
                this.logs.arg2 = hexdumpMem(this.arg2);
                this.logs.arg3 = hexdumpMem(this.arg3);
                this.logs.arg4 = hexdumpMem(this.arg4);
                this.logs.arg5 = hexdumpMem(this.arg5);

            }, onLeave: function (retval) {

                this.logs.leaveArg0 = hexdumpMem(this.arg0);
                this.logs.leaveArg1 = hexdumpMem(this.arg1);
                this.logs.leaveArg2 = hexdumpMem(this.arg2);
                this.logs.leaveArg3 = hexdumpMem(this.arg3);
                this.logs.leaveArg4 = hexdumpMem(this.arg4);
                this.logs.leaveArg5 = hexdumpMem(this.arg5);
                this.logs.retval = hexdumpMem(retval);

                fKLog.kLog(this.logs.call, this.logs);
            }
        })
    }
    ...
    function native_hook(library_name, function_names) {
        ...
        for (var i = 0; i < function_names.length; i++) {
            if (function_names[i].toUpperCase().startsWith("SUB_")) {
                ...
                fKLog.kLog("Hooking", { library_name: library_name, function_name: function_names[i], address: method_addr });
                ...
                if (method_addr) {
                    ...
                    fKLog.kLog("not fount", { library_name: library_name, function_name: function_names[i] });
                }
            }
    ...
    function main() {
        ...
        fKLog.kLog("traceNative.js init hook success");
        if (isSpawn) {
